!(function (a) {
    ...
    (k.generate = function (a) {
      ...
      (i.initWithData = function (a) {
        ...
        (d.axis = new f(d)),
          d.initPie && d.initPie(),
          d.initBrush && d.initBrush(),
          d.initZoom && d.initZoom(),
          g.bindto
            ? "function" == typeof g.bindto.node
              ? (d.selectChart = g.bindto)
              : (d.selectChart = e.select(g.bindto))
            : (d.selectChart = e.selectAll([])),
          d.selectChart.empty() &&
            ((d.selectChart = e
              .select(document.createElement("div"))
              .style("opacity", 0)),
            d.observeInserted(d.selectChart),
            (h = !1)),
          d.selectChart.html("").classed("c3", !0),
          (d.data.xs = {}),
          (d.data.targets = d.convertDataToTargets(a)),
          g.data_filter &&
            (d.data.targets = d.data.targets.filter(g.data_filter)),
          g.data_hide &&
            d.addHiddenTargetIds(
              g.data_hide === !0 ? d.mapToIds(d.data.targets) : g.data_hide
            ),
          g.legend_hide &&
            d.addHiddenLegendIds(
              g.legend_hide === !0 ? d.mapToIds(d.data.targets) : g.legend_hide
            ),
          d.hasType("gauge") && (g.legend_show = !1),
          d.updateSizes(),
          d.updateScales(),
          d.x.domain(e.extent(d.getXDomain(d.data.targets))),
          d.y.domain(d.getYDomain(d.data.targets, "y")),
          d.y2.domain(d.getYDomain(d.data.targets, "y2")),
          d.subX.domain(d.x.domain()),
          d.subY.domain(d.y.domain()),
          d.subY2.domain(d.y2.domain()),
          (d.orgXDomain = d.x.domain()),
          d.brush && d.brush.scale(d.subX),
          g.zoom_enabled && d.zoom.scale(d.x),
          (d.svg = d.selectChart
            .append("svg")
          ...
          d.config.svg_classname && d.svg.attr("class", d.config.svg_classname),
          (b = d.svg.append("defs")),
          (d.clipChart = d.appendClip(b, d.clipId)),
          (d.clipXAxis = d.appendClip(b, d.clipIdForXAxis)),
          (d.clipYAxis = d.appendClip(b, d.clipIdForYAxis)),
          (d.clipGrid = d.appendClip(b, d.clipIdForGrid)),
          (d.clipSubchart = d.appendClip(b, d.clipIdForSubchart)),
          d.updateSvgSize(),
          (c = d.main =
            d.svg.append("g").attr("transform", d.getTranslate("main"))),
          d.initSubchart && d.initSubchart(),
          d.initTooltip && d.initTooltip(),
          d.initLegend && d.initLegend(),
          d.initTitle && d.initTitle(),
          c
            .append("text")
          ...
          d.initRegion(),
          d.initGrid(),
          c.append("g").attr("clip-path", d.clipPath).attr("class", l.chart),
          g.grid_lines_front && d.initGridLines(),
          d.initEventRect(),
          d.initChartElements(),
          c
            .insert("rect", g.zoom_privileged ? null : "g." + l.regions)
            .attr("class", l.zoomRect)
            .attr("width", d.width)
            .attr("height", d.height)
            .style("opacity", 0)
            .on("dblclick.zoom", null),
          g.axis_x_extent && d.brush.extent(d.getDefaultExtent()),
          d.axis.init(),
      ...
      (i.updateSizes = function () {
        ...
        (a.currentWidth = a.getCurrentWidth()),
          ...
          (a.margin3 = { top: 0, right: NaN, bottom: 0, left: 0 }),
      ...
      (i.bindResize = function () {
        var b = this,
          c = b.config;
        if (
          ((b.resizeFunction = b.generateResize()),
          b.resizeFunction.add(function () {
            c.onresize.call(b);
          }),
          c.resize_auto &&
            b.resizeFunction.add(function () {
              void 0 !== b.resizeTimeout && a.clearTimeout(b.resizeTimeout),
                (b.resizeTimeout = a.setTimeout(function () {
          ...
          var d = a.onresize;
          d
            ? (d.add && d.remove) || ((d = b.generateResize()), d.add(a.onresize))
            : (d = b.generateResize()),
            d.add(b.resizeFunction),
            (a.onresize = d);
        }
      }),
      ...
      (i.trimXDomain = function (a) {
        var b = this.getZoomDomain(),
          ...
          d = b[1];
        return (
          a[0] <= c && ((a[1] = +a[1] + (c - a[0])), (a[0] = c)),
          d <= a[1] && ((a[0] = +a[0] - (a[1] - d)), (a[1] = d)),
          a
        );
      }),
      (i.isX = function (a) {
      ...
      (i.addName = function (a) {
        ...
        return (
          a &&
            ((b = c.config.data_names[a.id]), (a.name = void 0 !== b ? b : a.id)),
          a
        );
      }),
      ...
      (i.convertUrlToData = function (a, b, c, d, e) {
        ...
        c &&
          ...
          h.get(function (a, b) {
            ...
            (c =
              "json" === g
                ? f.convertJsonToData(JSON.parse(b.response), d)
                : "tsv" === g
                ? f.convertTsvToData(b.response)
                : f.convertCsvToData(b.response)),
              e.call(f, c);
          });
      }),
      ...
      (i.convertDataToTargets = function (a, b) {
        ...
        return (
            ...
            return {
              ...
              values: a
                .map(function (a, g) {
                  ...
                  return (
                    d.isCustomX() && d.isCategorized() && 0 === c && !p(j)
                      ? (0 === c && 0 === g && (e.axis_x_categories = []),
                        (h = e.axis_x_categories.indexOf(j)),
                        -1 === h &&
                          ((h = e.axis_x_categories.length),
                          e.axis_x_categories.push(j)))
                      : (h = d.generateTargetX(j, b, g)),
                    (p(a[b]) || d.data.xs[b].length <= g) && (h = void 0),
                    { x: h, value: k, id: f }
                  );
                })
                .filter(function (a) {
          ...
          (d.hasNegativeValue = d.hasNegativeValueInTargets(c)),
          (d.hasPositiveValue = d.hasPositiveValueInTargets(c)),
          e.data_type &&
            d.setTargetType(
        ...
        a.append("rect")
          ...
          .on("mousemove", function () {
            ...
            if (!c.dragging && !c.hasArcType(i)) {
              ...
              (g =
                ...
                c.showXGridFocus(h),
                (c.isBarType(f.id) || c.dist(f, a) < e.point_sensitivity) &&
          ...
          .on("click", function () {
            ...
            c.hasArcType(f) ||
              ...
              b &&
                (c.isBarType(b.id) || c.dist(b, a) < e.point_sensitivity) &&
                c.main
      ...
      (i.getCurrentHeight = function () {
        ...
        return c > 0
          ? c
          : 320 / (a.hasType("gauge") && !b.gauge_fullCircle ? 2 : 1);
      }),
          ...
          ? "x" === a && c.axis_x_height
            ...
            ? "y2" !== a || c.axis_y2_show
              ? ("x" === a &&
                ...
                "y" === a &&
                  c.axis_rotated &&
                  c.axis_y_tick_rotate &&
                  (d =
                    30 +
                    b.axis.getMaxTickWidth(a) *
                      Math.cos((Math.PI * (90 - c.axis_y_tick_rotate)) / 180)),
                d +
          ...
          return (
            e.forEach(function (c) {
              ...
              c.id !== a.id &&
                ...
                (("undefined" != typeof e[g] && +e[g].x === +a.x) ||
                  ((g = -1),
      ...
      (i.getInterpolate = function (a) {
        var b = this,
          c = b.isInterpolationType(b.config.spline_interpolation_type)
            ? b.config.spline_interpolation_type
            : "cardinal";
      ...
      (i.redrawLine = function (a, b) {
        return [
          (b ? this.mainLine.transition(Math.random().toString()) : this.mainLine)
            .attr("d", a)
        ...
        if (q(d))
          for (g = 0; g < d.length; g++)
            (z[g] = {}),
              p(d[g].start)
                ? (z[g].start = a[0].x)
                : (z[g].start = u.isTimeSeries()
                    ? u.parseDate(d[g].start)
                    : d[g].start),
              p(d[g].end)
                ? (z[g].end = a[a.length - 1].x)
                : (z[g].end = u.isTimeSeries()
                    ? u.parseDate(d[g].end)
                    : d[g].end);
        for (
          s = v.axis_rotated
      ...
      (i.redrawArea = function (a, b) {
        return [
          (b ? this.mainArea.transition(Math.random().toString()) : this.mainArea)
            .attr("d", a)
      ...
      (i.redrawCircle = function (a, b, c) {
        ...
        return [
          (c
            ...
            .attr("cx", a)
            .attr("cy", b),
          (c ? d.transition(Math.random().toString()) : d)
            .attr("cx", a)
            .attr("cy", b),
        ];
      }),
      ...
      (i.redrawBar = function (a, b) {
        return [
          (b ? this.mainBar.transition(Math.random().toString()) : this.mainBar)
            .attr("d", a)
            .style("fill", this.color)
            .style("opacity", 1),
        ];
      ...
      (i.getYForText = function (a, b, c) {
        ...
        return (
          e.config.axis_rotated
            ...
            : ((d = a[2][1]),
              b.value < 0 || (0 === b.value && !e.hasPositiveValue)
                ? ((d += f.height),
      ...
      (i.getTooltipContent = function (a, b, c, d) {
        ...
        if (0 === l.data_groups.length)
          ...
          a.sort(function (a, b) {
            ...
            return (
              c > 0 &&
                d > 0 &&
                ((c = a ? q.indexOf(a.id) : null),
                (d = b ? q.indexOf(b.id) : null)),
              p ? c - d : d - c
            );
          });
        }
        for (f = 0; f < a.length; f++)
          if (
            ...
            (h = y(o(a[f].value, a[f].ratio, a[f].id, a[f].index, a))),
            void 0 !== h)
          ) {
            if (null === a[f].name) continue;
            (i = y(n(a[f].name, a[f].ratio, a[f].id, a[f].index))),
              (j = k.levelColor ? k.levelColor(a[f].value) : d(a[f].id)),
              (e +=
                "<tr class='" +
                k.CLASS.tooltipName +
                "-" +
                k.getTargetSelectorSuffix(a[f].id) +
                "'>"),
              (e +=
      ...
      (i.updateLegend = function (a, b, c) {
        function d(a, b) {
          return (
            y.legendItemTextBox[b] ||
              (y.legendItemTextBox[b] = y.getTextRect(
                a.textContent,
                l.legendItem,
                a
              )),
        ...
        function e(b, c, e) {
          function f(a, b) {
            b ||
              ((g = (o - G - n) / 2), E > g && ((g = (o - n) / 2), (G = 0), M++)),
              (L[a] = M),
              (K[M] = y.isLegendInset ? 10 : g),
              (H[a] = G),
              (G += n);
          }
          var g,
            ...
            l =
              k.width +
              F +
              (!j || y.isLegendRight || y.isLegendInset ? B : 0) +
              z.legend_padding,
            m = k.height + A,
            n = y.isLegendRight || y.isLegendInset ? m : l,
            o =
              y.isLegendRight || y.isLegendInset
                ? y.getLegendHeight()
                : y.getLegendWidth();
          return (
            i && ((G = 0), (M = 0), (C = 0), (D = 0)),
            z.legend_show && !y.isLegendToShow(c)
              ? void (I[c] = J[c] = L[c] = H[c] = 0)
              : ((I[c] = l),
                (J[c] = m),
                (!C || l >= C) && (C = l),
                (!D || m >= D) && (D = m),
                (h = y.isLegendRight || y.isLegendInset ? D : C),
                void (z.legend_equally
        ...
        (a = a.filter(function (a) {
          ...
          (b = b || {}),
          (r = w(b, "withTransition", !0)),
          (s = w(b, "withTransitionForTransform", !0)),
          y.isLegendInset &&
            ((M = z.legend_inset_step ? z.legend_inset_step : a.length),
            y.updateLegendStep(M)),
          y.isLegendRight
            ? ((f = function (a) {
                return C * L[a];
              }),
          ...
          (p = y.legend
            ...
            .on("click", function (a) {
              z.legend_item_onclick
                ? z.legend_item_onclick.call(y, a)
                : y.d3.event.altKey
                ? (y.api.hide(), y.api.show(a))
                : (y.api.toggle(a),
                  y.isTargetToShow(a) ? y.api.focus(a) : y.api.revert());
            })
            .on("mouseover", function (a) {
              z.legend_item_onmouseover
                ? z.legend_item_onmouseover.call(y, a)
                : (y.d3.select(this).classed(l.legendItemFocused, !0),
                  !y.transiting && y.isTargetToShow(a) && y.api.focus(a));
            })
            .on("mouseout", function (a) {
              z.legend_item_onmouseout
                ? z.legend_item_onmouseout.call(y, a)
                : (y.d3.select(this).classed(l.legendItemFocused, !1),
                  y.api.revert());
            })),
          p
            .append("text")
            ...
            .attr("y", y.isLegendRight || y.isLegendInset ? -200 : j),
          p
            .append("rect")
            .attr("class", l.legendItemEvent)
            .style("fill-opacity", 0)
            .attr("x", y.isLegendRight || y.isLegendInset ? h : -200)
            .attr("y", y.isLegendRight || y.isLegendInset ? -200 : k),
          p
            .append("line")
          ...
          (x = y.legend.select("." + l.legendBackground + " rect")),
          y.isLegendInset &&
            C > 0 &&
            0 === x.size() &&
            (x = y.legend
          ...
          (r ? t.transition() : t).attr("x", g).attr("y", j),
          (u = y.legend.selectAll("rect." + l.legendItemEvent).data(a)),
          (r ? u.transition() : u)
            ...
            .attr("x", h)
            .attr("y", k),
          (v = y.legend.selectAll("line." + l.legendItemTile).data(a)),
          (r ? v.transition() : v)
            .style("stroke", y.color)
            .attr("x1", m)
            .attr("y1", o)
          ...
          x &&
            (r ? x.transition() : x)
              .attr("height", y.getLegendHeight() - 12)
              .attr("width", C * (M + 1) + 10),
          y.legend
            .selectAll("." + l.legendItem)
          ...
          y.updateLegendItemWidth(C),
          y.updateLegendItemHeight(D),
          y.updateLegendStep(M),
          y.updateSizes(),
          y.updateScales(),
          y.updateSvgSize(),
          y.transformAll(s, c),
          (y.legendHasRendered = !0);
      }),
      (i.initTitle = function () {
        var a = this;
        a.title = a.svg
          .append("text")
          .text(a.config.title_text)
          .attr("class", a.CLASS.title);
      }),
      ...
      (i.xForTitle = function () {
        ...
        return (a =
          d.indexOf("right") >= 0
            ? b.currentWidth -
              b.getTextRect(
                b.title.node().textContent,
                b.CLASS.title,
                b.title.node()
              ).width -
              c.title_padding.right
            : d.indexOf("center") >= 0
            ? (b.currentWidth -
                b.getTextRect(
                  b.title.node().textContent,
              ...
              2
            : c.title_padding.left);
      }),
      (i.yForTitle = function () {
        var a = this;
        return (
          a.config.title_padding.top +
          a.getTextRect(a.title.node().textContent, a.CLASS.title, a.title.node())
            .height
        );
      }),
      ...
      (f.prototype.getYAxis = function (a, b, c, d, e, f, h) {
        ...
        return (
          i.isTimeSeriesY()
            ? l.ticks(
                i.d3.time[j.axis_y_tick_time_value],
                j.axis_y_tick_time_interval
              )
            : l.tickValues(d),
          l
        );
      ...
      (f.prototype.getPadding = function (a, b, c, d) {
        ...
        return m(e)
          ? "ratio" === a.unit
            ? a[b] * d
            : this.convertPixelsToAxisPadding(e, d)
          : c;
      }),
      ...
      (i.updateAngle = function (a) {
        var b,
          ...
          i = 0;
        return g
          ? (f.pie(f.filterTargetsToShow(f.data.targets)).forEach(function (b) {
              h || b.data.id !== a.data.id || ((h = !0), (a = b), (a.index = i)),
                i++;
            }),
            isNaN(a.startAngle) && (a.startAngle = 0),
            isNaN(a.endAngle) && (a.endAngle = a.startAngle),
            f.isGaugeType(a.data) &&
              ((b = g.gauge_min),
              (c = g.gauge_max),
              (d = (Math.PI * (g.gauge_fullCircle ? 2 : 1)) / (c - b)),
              (e = a.value < b ? 0 : a.value < c ? a.value - b : c - b),
              (a.startAngle = g.gauge_startingAngle),
              (a.endAngle = a.startAngle + d * e)),
            h ? a : null)
          : null;
      }),
      ...
      (i.transformForArcLabel = function (a) {
        ...
        return (
          i &&
            !g.hasType("gauge") &&
            ((b = this.svgArc.centroid(i)),
            (c = isNaN(b[0]) ? 0 : b[0]),
            (d = isNaN(b[1]) ? 0 : b[1]),
            (e = Math.sqrt(c * c + d * d)),
            (f =
              g.hasType("donut") && h.donut_label_ratio
                ? n(h.donut_label_ratio)
                  ? h.donut_label_ratio(a, g.radius, e)
                  : h.donut_label_ratio
                : g.hasType("pie") && h.pie_label_ratio
                ? n(h.pie_label_ratio)
                  ? h.pie_label_ratio(a, g.radius, e)
                  : h.pie_label_ratio
                : g.radius && e
              ...
              .each(function (a) {
                d.shouldExpand(a.data.id) &&
                  d.d3
                    ...
                    .selectAll("path")
                    .transition()
                    .duration(d.expandDuration(a.data.id))
      ...
      (i.expandDuration = function (a) {
        var b = this,
          c = b.config;
        return b.isDonutType(a)
          ? c.donut_expand_duration
          : b.isGaugeType(a)
          ? c.gauge_expand_duration
          : b.isPieType(a)
          ? c.pie_expand_duration
          : 50;
      }),
          ...
          d
            ...
            .each(function (a) {
              e.isGaugeType(a.data) &&
                (a.startAngle = a.endAngle = g.gauge_startingAngle),
                (this._current = a);
            }),
          d
              ...
              g.interaction_enabled
                ? function (a) {
                    var b,
                      ...
                      d = e.updateAngle(a);
                    d &&
                      ((b = e.convertToArcData(d)),
                      (c = [b]),
                      e.showTooltip(c, this));
                  }
                : null
            )
            .on(
              ...
              g.interaction_enabled
                ? function (a, b) {
                    var c,
                      d = e.updateAngle(a);
                    d &&
                      ((c = e.convertToArcData(d)),
                      e.toggleShape && e.toggleShape(this, c, b),
                      e.config.data_onclick.call(e.api, c, this));
                  }
                : null
            )
            .each(function () {
          ...
          e.hasType("gauge") &&
            ...
            e.arcs
              ...
              .attr(
                ...
                -1 *
                  (e.innerRadius +
                    (e.radius - e.innerRadius) / (g.gauge_fullCircle ? 1 : 2)) +
                  "px"
              )
              .attr("dy", "1.2em")
      ...
      (i.updateRegion = function (a) {
        ...
        b.region.style("visibility", b.hasArcType() ? "hidden" : "visible"),
          ...
          b.mainRegion
            ...
            .append("rect")
            .style("fill-opacity", 0),
          b.mainRegion.attr("class", b.classRegion.bind(b)),
          b.mainRegion
            .exit()
            .transition()
            .duration(a)
      ...
      (i.unselectPoint = function (a, b, c) {
        var d = this;
        d.config.data_onunselected.call(d.api, b, a.node()),
          d.main
            .select("." + l.selectedCircles + d.getTargetSelectorSuffix(b.id))
            .selectAll("." + l.selectedCircle + "-" + c)
            .transition()
      ...
      (i.redrawBarForSubchart = function (a, b, c) {
        (b
          ? this.contextBar.transition(Math.random().toString()).duration(c)
          : this.contextBar
        )
          .attr("d", a)
          .style("opacity", 1);
      ...
      (i.redrawLineForSubchart = function (a, b, c) {
        (b
          ? this.contextLine.transition(Math.random().toString()).duration(c)
          : this.contextLine
        )
          .attr("d", a)
          .style("opacity", 1);
      ...
      (i.redrawAreaForSubchart = function (a, b, c) {
        (b
          ? this.contextArea.transition(Math.random().toString()).duration(c)
          : this.contextArea
        )
          .attr("d", a)
          .style("fill", this.color)
    ...
    (h.focus = function (a) {
      ...
      (h.zoom.max = function (a) {
        var b = this.internal,
          ...
          d = b.d3;
        return 0 === a || a
          ? void (c.zoom_x_max = d.max([b.orgXDomain[1], a]))
          : c.zoom_x_max;
      }),
      (h.zoom.min = function (a) {
        var b = this.internal,
          ...
          d = b.d3;
        return 0 === a || a
          ? void (c.zoom_x_min = d.min([b.orgXDomain[0], a]))
          : c.zoom_x_min;
      }),
      (h.zoom.range = function (a) {
        return arguments.length
          ? (q(a.max) && this.domain.max(a.max),
            void (q(a.min) && this.domain.min(a.min)))
          : { max: this.domain.max(), min: this.domain.min() };
      }),
      (h.load = function (a) {
        var b = this.internal,
          c = b.config;
        return (
          a.xs && b.addXs(a.xs),
          "names" in a && h.data.names.bind(this)(a.names),
          "classes" in a &&
      ...
      (h.tooltip.show = function (a) {
        ...
        a.mouse && (c = a.mouse),
          ...
          d.config.tooltip_onshow.call(d, a.data);
      }),
    ...
    (i.isSafari = function () {
      ...
      (function () {
        "SVGPathSeg" in a ||
          ...
          (SVGPathSegCurvetoCubicAbs.prototype = Object.create(
          ...
          (SVGPathSegCurvetoCubicRel.prototype = Object.create(
            SVGPathSeg.prototype
          )),
          ...
          (SVGPathSegLinetoVerticalAbs.prototype = Object.create(
            SVGPathSeg.prototype
          )),
          ...
          (SVGPathSegLinetoVerticalRel.prototype = Object.create(
            SVGPathSeg.prototype
          )),
          ...
          (SVGPathElement.prototype.createSVGPathSegLinetoVerticalAbs = function (
            a
          ) {
            return new SVGPathSegLinetoVerticalAbs(void 0, a);
          }),
          (SVGPathElement.prototype.createSVGPathSegLinetoVerticalRel = function (
            a
          ) {
              ...
              (d.prototype._isCurrentSpace = function () {
                ...
                (d.prototype._nextCommandHelper = function (a, b) {
                  return ("+" == a ||
                    ...
                    "." == a ||
                    (a >= "0" && "9" >= a)) &&
                    b != SVGPathSeg.PATHSEG_CLOSEPATH
                    ? b == SVGPathSeg.PATHSEG_MOVETO_ABS
                      ? SVGPathSeg.PATHSEG_LINETO_ABS
                      : b == SVGPathSeg.PATHSEG_MOVETO_REL
                ...
                (d.prototype.initialCommandIsMoveTo = function () {
                  ...
                  return (
                    a == SVGPathSeg.PATHSEG_MOVETO_ABS ||
                    a == SVGPathSeg.PATHSEG_MOVETO_REL
                  );
                }),
                ...
                (d.prototype.parseSegment = function () {
                  ...
                  if (c == SVGPathSeg.PATHSEG_UNKNOWN) {
                    if (this._previousCommand == SVGPathSeg.PATHSEG_UNKNOWN)
                      return null;
                    if (
                      ((c = this._nextCommandHelper(a, this._previousCommand)),
                      c == SVGPathSeg.PATHSEG_UNKNOWN)
                    )
                      return null;
                  ...
                  switch (((this._previousCommand = c), c)) {
                    ...
                    case SVGPathSeg.PATHSEG_CLOSEPATH:
                      return (
                        this._skipOptionalSpaces(), new SVGPathSegClosePath(b)
                      );
